# Cloud operating system BAYRELL Cloud OS

**BAYRELL Cloud OS** is an **open-source cloud operating system** with the ability to install and manage cloud applications.

**Features:**
- Deploy private cloud on your own servers
- Web interface for managing Docker cluster
- Automatic generation of YAML files for deployment
- Built-in HTTP router for traffic management
- Ability to deploy MySQL, PHP and other services with minimal setup
...
- cloud IDE systems for software development;
- version control system;
- cloud digital repository of source code for IT companies;
- automation of CI/CD processes;
- corporate business systems, CRM, ERP;
- web hosting management systems;
- IoT devices;
- smart home systems;
- etc


## Advantages of BAYRELL Cloud OS
